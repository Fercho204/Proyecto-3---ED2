...
int main(void)
{
  ...
  while (1)
  {
	...
	//PARQUEO 4
	 ...
	 switch(parqueo_dis) {
	         case 0: // NUMERO 0
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DB_Pin|DC_Pin|DD_Pin|DE_Pin|DF_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DG_Pin, 0); parqueo_dis = 8; break;
	         case 1: // NUMERO 1
	        		HAL_GPIO_WritePin(GPIOC, DB_Pin|DC_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DF_Pin|DG_Pin|DE_Pin|DD_Pin, 0); parqueo_dis = 8; break;
	         case 2: // NUMERO 2
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DB_Pin|DG_Pin|DE_Pin|DD_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DF_Pin|DC_Pin, 0); parqueo_dis = 8; break;
	         case 3: // NUMERO 3
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DB_Pin|DG_Pin|DC_Pin|DD_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DF_Pin|DE_Pin, 0); parqueo_dis = 8; break;
	         case 4:// NUMERO 4
	        		HAL_GPIO_WritePin(GPIOC, DF_Pin|DG_Pin|DB_Pin|DC_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DE_Pin|DD_Pin, 0); parqueo_dis = 8; break;
	         case 5: // NUMERO 5
	        		HAL_GPIO_WritePin(GPIOC, DA_Pin|DF_Pin|DG_Pin|DC_Pin|DD_Pin, 1);
	        		HAL_GPIO_WritePin(GPIOC, DB_Pin|DE_Pin, 0); parqueo_dis = 8; break;
	         case 6: // NUMERO 6
	             HAL_GPIO_WritePin(GPIOC, DA_Pin|DF_Pin|DE_Pin|DD_Pin|DC_Pin|DG_Pin, 1);
	             HAL_GPIO_WritePin(GPIOC, DB_Pin, 0); parqueo_dis = 8; break;

	         case 7: // NUMERO 7
	             HAL_GPIO_WritePin(GPIOC, DA_Pin|DB_Pin|DC_Pin, 1);
	             HAL_GPIO_WritePin(GPIOC, DF_Pin|DE_Pin|DD_Pin|DG_Pin, 0); parqueo_dis = 8; break;

	         case 8: // NUMERO 8
	             HAL_GPIO_WritePin(GPIOC, DA_Pin|DB_Pin|DC_Pin|DD_Pin|DE_Pin|DF_Pin|DG_Pin, 1);
	             parqueo_dis = 8; break;
	 	}
  }
  /* USER CODE END 3 */
...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOC, DG_Pin|DA_Pin|LCD_RST_Pin|DB_Pin
                          |DC_Pin|VP1_Pin|RP1_Pin|LCD_D1_Pin
                          |VP3_Pin|RP3_Pin|DD_Pin|DE_Pin
                          |DF_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : DG_Pin DA_Pin DB_Pin DC_Pin
                           VP1_Pin RP1_Pin VP3_Pin RP3_Pin
                           DD_Pin DE_Pin DF_Pin */
  GPIO_InitStruct.Pin = DG_Pin|DA_Pin|DB_Pin|DC_Pin
                          |VP1_Pin|RP1_Pin|VP3_Pin|RP3_Pin
                          |DD_Pin|DE_Pin|DF_Pin;
